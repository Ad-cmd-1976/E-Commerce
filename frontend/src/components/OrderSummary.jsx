...
const OrderSummary = () => {
    ...
    const stripePromise=loadStripe("pk_test_51RNciuRXenXKWDOKMLBCAa7cGcCHPhCl7KXerhvmg4TK15EIANhMUzlNIqmLhyg4ZAbDetVTQerEEkxBZUIkvWLb00ARpOAghC");
            ...
            <div className='space-y-2'>
                ...
                { coupon && isCouponApplied && (
                    <dl className='flex items-center justify-between gap-4'>
                        ...
                        <dd className='text-base font-normal text-emerald-400'>-{coupon.discountPercentage}%</dd>
                    </dl>
                )}
                <dl className='flex items-center justify-between gap-4 border-t border-gray-600'>
                    ...
                    <dd className='text-base font-normal text-emerald-400'>${formattedTotal}</dd>
                </dl>
            </div>
