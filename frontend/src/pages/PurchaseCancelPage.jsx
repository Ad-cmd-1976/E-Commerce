    ...
    <div className='min-h-screen flex items-center justify-center px-4'>
      ...
      >
        <div className="p-6 sm:p-8">
          ...
          <p className="text-gray-300 text-center mb-6">Your Order Has Been Cancelled. No Charges Made</p>
          <div className="bg-gray-700 rounded-lg p-4 mb-6">
            <p className="text-sm text-gray-400 text-center">
              If you encountered any issues in the checkout process, please {"don't"} hesitate to contact our support team
            </p>
          </div>
